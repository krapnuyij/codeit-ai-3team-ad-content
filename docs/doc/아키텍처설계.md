...
graph TB
    ...
    MCPServer -->|REST API<br/>Internal Network| ModelServer
...
graph TB
    subgraph "GCP VM Instance (L4 GPU)"
        subgraph "Docker Network: nanococoa-network"
            ...
            Container3["Container 3<br/>nanoCocoa_aiserver<br/>FastAPI + AI Models<br/>Port: 8000 (외부)"]
            Container4["Container 4<br/>nanoCocoa_mcpserver<br/>MCP Bridge<br/>Port: 3000 (외부)"]
        end
