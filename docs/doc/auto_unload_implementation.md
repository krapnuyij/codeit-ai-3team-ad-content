...
|------|-----------|-------------|-----------|
| Step 1<br/>(배경 생성) | Flux | Step 2 완료 후 | Flux |
| Step 2<br/>(텍스트) | SDXL<br/>BiRefNet | Step 3 시작 전 | SDXL<br/>BiRefNet<br/>+ Flux (중복방지) |
| Step 3<br/>(합성) | Flux<br/>Inpainting | Step 3 완료 후 | Flux Inpainting |
