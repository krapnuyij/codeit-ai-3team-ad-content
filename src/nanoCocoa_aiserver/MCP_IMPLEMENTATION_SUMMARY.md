# nanoCocoa MCP Server - Implementation Summary

## 프로젝트 개요

nanoCocoa AI 광고 생성 서버를 위한 MCP (Model Context Protocol) 서버 구현이 완료되었습니다.
LLM(Claude 등)이 REST API를 통해 AI 광고 이미지를 생성할 수 있도록 표준화된 인터페이스를 제공합니다.
...
| `nanococoa://help/parameters` | 파라미터 상세 레퍼런스 |
| `nanococoa://help/examples` | 코드 예시 및 워크플로우 |
