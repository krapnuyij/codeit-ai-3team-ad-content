...
MCP_TOOLS = [
    {
        ...
        "inputSchema": {
            ...
            "required": ["product_image_path", "background_prompt", "text_content", "text_style_prompt"]
        }
    },
