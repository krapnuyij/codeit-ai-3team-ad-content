"""
nanoCocoa MCP Server (FastMCP 표준)
MCP 프로토콜을 통해 nanoCocoa_aiserver를 제어하는 서버
"""
...
# 로깅 설정 (FastMCP는 stdio를 사용하므로 stderr만 사용)
# MCP stdio 프로토콜은 stdout을 사용하므로 모든 로그는 stderr로만 출력해야 함
logging.basicConfig(
    level=logging.INFO,
